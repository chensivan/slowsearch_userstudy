...
//    alert(b)
  ...
  $scope.answers = [{
                      ...
                      'answer': ["you could use .match(), .replace() function, /\s+/g expression, /[0-9]/g, and /[.?]/g expression", "level 22", "level 33", "level 44", "level 55", "level 66", "level 77"],
                      'value': 5,
                      options: {
                        floor: 0,
                        ceil: 10,
